from sentences import get_determiner, get_noun, get_verb, get_preposition, get_prepositional_phrase, get_adverb, get_adjective
import random
import pytest
...
def test_get_adverb():
    # Test adverbs
    adverbs =  ["slowly", "fast", "carefully", "carelessly", "effortlessly", "urgently", "always", "almost always", "usually", "often", "sometimes", "occasionally", "seldom", "rarely", 
        "almost never","never", "quietly", "possibly", "incredibly", "probably", "luckily", "happily", "angrily", "ironically", "basically"]
    ...
    for _ in range(4):
        ...
        # Verify that the adverbs returned from get_adverb is one of the words in the adverts list.
