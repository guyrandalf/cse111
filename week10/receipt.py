...
def main():
    try:
        ...
        with open("request.csv", "r") as csv_file:
            ...
            # Include variables for price and total
            number_of_items = 0
            sub_total = 0
            for row in reader:
                product_name = products_dictionary[row[PRODUCT_ID_INDEX]][1]
                product_price = products_dictionary[row[PRODUCT_ID_INDEX]][2]
            ...
            print("If you are satisfied with our services, feel free to complete this online survey: https://survey.inkomemporium.com")
