...
def main():
    ...
    # Call the m_from_cm_from_in function to convert from inches to centimeters to meters.
    m = m_from_cm_from_in(inches)

    # Call the body_mass_index function.
    bmi = body_mass_index(kg, m)

    # Call the basal_metabolic_rate function.
    bmr = basal_metabolic_rate(gender, kg, m, years)
